    ...
    def validate(self):
        if not self.setup_instructions_html:
            self.setup_instructions_html = (
                ...
                '<li><strong>Add employee mappings</strong> — for each employee, enter their Template ID from the device and select this device.</li>'
...
def test_connection(device_name):
    ...
    from hrms2.utils.biometric_sync import test_device_connection
